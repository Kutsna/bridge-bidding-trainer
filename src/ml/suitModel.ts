...
let suitModel: tf.GraphModel | null = null;

export const loadSuitModel = async () => {
  suitModel = await tf.loadGraphModel('/models/suit/model.json');
};

export const getSuitModel = () => suitModel;
