...
let rankModel: tf.GraphModel | null = null;

export const loadRankModel = async () => {
  rankModel = await tf.loadGraphModel('/models/rank/model.json');
};

export const getRankModel = () => rankModel;
